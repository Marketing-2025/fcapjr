...
export function ContactForm() {
  ...
  useEffect(() => {
    if (location.hash === "#form-contato-home") {
      const el = document.getElementById("form-contato-home");
      if (el) {
  ...
  return (
    <Box sx={{ maxWidth: "700px" }}>
      <Box
        component="form"
        id="form-contato-home" // <-- ID exclusivo para o formulário da home
      ...
      >
        ...
        <InputLabel
          htmlFor="email-label"
          sx={{ color: "#005396", fontWeight: "bold", mt: 1 }}
        >
          E-mail
        </InputLabel>
        <TextField

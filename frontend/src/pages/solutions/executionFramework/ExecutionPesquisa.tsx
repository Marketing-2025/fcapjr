...
interface ExecutionPesquisaProps {
  className?: string;
}

export const ExecutionPesquisa: React.FC<ExecutionPesquisaProps> = ({
  className = "",
}) => {
  return (
    <Box sx={{ backgroundColor: "#f5f5f0", minHeight: "100vh" }}>
      <Container maxWidth="lg" className={className}>
        ...
        <Description>
          ...
          a solução de{" "}
          <span className="font-bold text-[#0d5a94]">Pesquisa de Mercado</span>{" "}
        ...
        <Grid container spacing={12} className="mb-12 relative">
          ...
          >
            <ProcessStep
              ...
              description="Levantamento e análise de dados do mercado, concorrência e perfil do consumidor"
            />
          </Grid>
          ...
          >
            <ProcessStep
              ...
              description="Implementação de ferramentas personalizadas para análise contínua e ajustes estratégicos com base nos resultados"
              position="right"
            />
          </Grid>

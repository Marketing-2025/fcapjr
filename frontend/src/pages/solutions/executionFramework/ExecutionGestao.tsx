...
interface ExecutionGestaoProps {
  className?: string;
}

export const ExecutionGestao: React.FC<ExecutionGestaoProps> = ({
  className = "",
}) => {
  return (
    <Box sx={{ backgroundColor: "#f5f5f0", minHeight: "100vh" }}>
      <Container maxWidth="lg" className={className}>
        ...
        <Description>
          ...
          a solução de{" "}
          <span className="font-bold text-[#0d5a94]">Gestão Estratégica</span>{" "}
        ...
        <Grid container spacing={12} className="mb-12 relative">
          ...
          >
            <ProcessStep
              number={1}
              title="Diagnóstico e Análise de Cenário"
              description="Análise do contexto interno e externo da empresa"
            />
          </Grid>
          ...
          >
            <ProcessStep
              ...
              description="Apoio a implementação do plano estratégico e fornecimento de ferramentas práticas para acompanhar o desempenho"
              position="right"
            />
          </Grid>
          ...
          >
            ...
            >
              <ProcessStep
                number={2}
                title="Construção do Plano Estratégico"
                description="Desenvolvimento de metas e estratégias de longo prazo alinhadas aos objetivos do negócio"
                position="center"
              />
            </Grid>

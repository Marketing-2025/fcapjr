...
interface ExecutionMarketingProps {
  className?: string;
}

export const ExecutionMarketing: React.FC<ExecutionMarketingProps> = ({
  className = "",
}) => {
  return (
    <Box sx={{ backgroundColor: "#f5f5f0", minHeight: "100vh" }}>
      <Container maxWidth="lg" className={className}>
        ...
        <Description>
          ...
          a solução de{" "}
          <span className="font-bold text-[#0d5a94]">Marketing e vendas</span>{" "}
        ...
        <Grid container spacing={12} className="mb-12 relative">
          ...
          >
            <ProcessStep
              ...
              description="Estudo aprofundado do cenário de mercado e do comportamento do consumidor"
            />
          </Grid>
          ...
          >
            <ProcessStep
              ...
              description="Construção de todo o funil de vendas, mapeamento da jornada do cliente e criação de abordagens alinhadas com os objetivos"
              position="right"
            />
          </Grid>
          ...
          >
            ...
            >
              <ProcessStep
                ...
                description="Desenvolvimento de um modelo de vendas personalizado e eficiente"
                position="center"
              />
            </Grid>

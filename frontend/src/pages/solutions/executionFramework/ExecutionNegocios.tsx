...
interface ExecutionNegociosProps {
  className?: string;
}

export const ExecutionNegocios: React.FC<ExecutionNegociosProps> = ({
  className = "",
}) => {
  return (
    <Box sx={{ backgroundColor: "#f5f5f0", minHeight: "100vh" }}>
      <Container maxWidth="lg" className={className}>
        ...
        <Description>
          ...
          a solução de{" "}
          <span className="font-bold text-[#0d5a94]">Plano de Negócios</span>{" "}
        ...
        <Grid container spacing={12} className="mb-12 relative">
          ...
          >
            <ProcessStep
              ...
              description="Avaliação de oportunidades de mercado"
            />
          </Grid>
          ...
          >
            <ProcessStep
              number={3}
              title="Implementação e Monitoramento de Resultados"
              description="Apoio a implementação do plano de negócios e fornecimento de ferramentas para monitorar resultados"
              position="right"
            />
          </Grid>
          ...
          >
            ...
            >
              <ProcessStep
                number={2}
                title="Planejamento Negócios"
                description="Desenvolvimento de um plano estratégico inovador com ações necessárias para a expansão"
                position="center"
              />
            </Grid>

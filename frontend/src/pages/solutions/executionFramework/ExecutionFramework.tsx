...
export const ExecutionFramework: React.FC<ExecutionFrameworkProps> = ({
  className = "",
}) => {
  return (
    <Box sx={{ backgroundColor: "#f5f5f0", minHeight: "100vh" }}>
      <Container maxWidth="lg" className={className}>
        ...
        <Description>
          ...
          a solução de{" "}
          <span className="font-bold text-[#0d5a94]">
        ...
        <Grid container spacing={12} className="mb-12 relative">
          ...
          >
            <ProcessStep
              ...
              description="Coleta dos processos atuais e identificação de áreas de melhoria"
            />
          </Grid>
          ...
          >
            <ProcessStep
              ...
              description="Monitoramento contínuo e ajustes regulares para otimizar os processos"
              position="right"
            />
          </Grid>
          ...
          >
            ...
            >
              <ProcessStep
                ...
                description="Redesenho personalizado de processos, definição de otimizações e indicadores de desempenho (KPIs)"
                position="center"
              />
            </Grid>

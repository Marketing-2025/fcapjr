  ...
  const challenges = [
    {
      ...
      description: "clara e direcionamento estratégico",
    },
    {
      title: "Deficiência no uso de tecnologias  ",
      description: "e dados para tomada de decisão",
    },
    {
      title: "Falta de adaptação",
      description: "às mudanças do mercado",
    },
  ];

...
const BusinessTab6 = () => {
  const challenges = [
    {
      title: "Desalinhamento de valores",
      description: "organizacionais e comportamentos da equipe",
    },
    {
      title: "Falta de estrutura",
      description: "clara de cargos e progressão interna",
    },
    {
      title: "Ausência de avaliações",
      description: " consistentes e feedbacks objetivos",
    },
  ];
    ...
    <Stack spacing={4}>
      {challenges.map((challenge, index) => (
        ...
        >
          ...
          <Typography
            variant="body1"
            sx={{ fontSize: "1.25rem" }} // Aumenta o tamanho da fonte da descrição
          >

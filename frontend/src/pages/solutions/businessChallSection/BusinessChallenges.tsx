...
const BusinessChallenges = () => {
  const challenges = [
    {
      title: "Processos ineficazes",
      description: "que geram desperdício de tempo e recursos",
    },
    {
      title: "Falta de visibilidade",
      description: "e controle sobre as operações internas",
    },
    {
      title: "Despadronização no controle ",
      description: "de qualidade interno",
    },
  ];
    ...
    <Stack spacing={4}>
      {challenges.map((challenge, index) => (
        ...
        >
          ...
          <Typography
            variant="body1"
            sx={{ fontSize: "1.2rem" }} // Aumenta o tamanho da fonte da descrição
          >

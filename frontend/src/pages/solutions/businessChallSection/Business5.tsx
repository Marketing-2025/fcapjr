...
const BusinessTab5 = () => {
  const challenges = [
    {
      title: "Ausência de entendimento",
      description: "sobre o consumidor e o mercado",
    },
    {
      title: "Dificuldade em tomar decisões",
      description: "estratégicas por falta de dados consistentes",
    },
    {
      title: "Baixo desempenho",
      description: "por falta de segmentação eficaz",
    },
  ];
